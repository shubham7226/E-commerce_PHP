...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Watch World Store!</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fastrack/download.jpg" alt="F_model1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>F_model1</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fastrack/download (1).jpg" alt="F_model2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>F_model2</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fastrack/download (2).jpg" alt="F_model3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>F_model3</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rado/download (1).jpg" alt="RD_model1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RD_model1</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rado/download.jpg" alt="RD_model2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RD_model2</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rado/images (2).jpg" alt="RD_model3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RD_model3</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rolex/images (2).jpg" alt="RL_model1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RL_model1</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rolex/images3.jpg" alt="RL_model2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RL_model2</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/rolex/images (1).jpg" alt="RL_model3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>RL_model3</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fossil/images (2).jpg" alt="FO_model1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>FO_model1</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fossil/images (3).jpg" alt="FO_model2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>FO_model2</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fossil/images (4).jpg" alt="FO_model3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>FO_model3</h3>
